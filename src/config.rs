...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("Waldlust".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["43.202.23.219"];
pub const RS_PUB_KEY: &str = "To92j9bv6bzEA8nLqvQ6jx0kVmekG8G9pkvM7KbQsCo=";
